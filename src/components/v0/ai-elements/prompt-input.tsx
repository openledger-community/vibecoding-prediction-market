...
export const PromptInput = ({
    ...
    return (
        <form
            className={cn(
                "w-full divide-y overflow-hidden rounded-xl border bg-background shadow-sm transition-colors relative z-10",
    ...
    return (
        <Textarea
            className={cn(
                ...
                "field-sizing-content max-h-[6lh] bg-transparent dark:bg-transparent text-gray-200 placeholder:text-gray-500",
                "focus-visible:ring-0 min-h-[60px]",
                className
            )}
            name="message"
            onChange={(e) => {
...
export const PromptInputToolbar = ({
    ...
    <div
        className={cn("flex items-center justify-between p-2 bg-[#0a0a0f]", className)}
        {...props}
    />
);
...
export const PromptInputButton = ({
    ...
    return (
        <Button
            className={cn(
                "shrink-0 gap-1.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/10",
...
export const PromptInputSubmit = ({
    ...
    if (status === "submitted") {
        Icon = <Loader className="size-4 animate-spin text-gray-400" />;
...
export const PromptInputModelSelectTrigger = ({
    ...
    <SelectTrigger
        className={cn(
            "border-none bg-transparent font-medium text-muted-foreground shadow-none transition-colors h-8 text-xs",
            "hover:bg-white/5 hover:text-foreground [&[aria-expanded='true']]:bg-white/5 [&[aria-expanded='true']]:text-foreground",
            className
        )}
        {...props}
    />
...
export const PromptInputModelSelectContent = ({
    ...
    <SelectContent className={cn("bg-[#1a1a20] border-white/10 text-gray-300", className)} {...props} />
);
...
export const PromptInputModelSelectItem = ({
    ...
    <SelectItem className={cn("text-xs focus:bg-white/10 focus:text-white", className)} {...props} />
);
...
export const PromptInputMicButton = ({
    ...
    const recognitionRef = useRef<any>(null); // Use any for SpeechRecognition
...
export const PromptInputImagePreview = ({
    ...
    return (
        <div className={cn("flex flex-wrap gap-2 p-2 bg-[#0a0a0f]", className)}>
